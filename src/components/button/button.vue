<template>
  <button class="wlin-button" :class="{[`icon-${iconPosition}`]: true, [`wlin-button--${type}`]: true, [`wlin-button--circle`]: circle, [`wlin-button--plain`]: plain}" @click="$emit('click')">
...
export default {
  ...
  props: {
    type: { // 按钮类型： primary主色、success成功、info信息、warning警告、danger危险
      type: String,
      default: '',
      validator(value){
